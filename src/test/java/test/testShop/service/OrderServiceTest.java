...
import test.testShop.domain.item.Book;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문 취소시 상태는 CANCEL 이다.", OrderStatus.ORDER, getOrder.getStatus());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상태는 그 만큼 재고가 증가해야 한다.", 10, item.getStockQuantity());
    }
